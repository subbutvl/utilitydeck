    ...
    <div className="h-full flex flex-col gap-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1 min-h-0">
        <div className="lg:col-span-4 bg-[#111] border border-neutral-800 p-8 space-y-6">
           <span className="text-[10px] uppercase text-neutral-500 font-bold tracking-widest block border-b border-neutral-800 pb-2">Macro Setup</span>
           <div className="space-y-6">
              ...
              <div className="space-y-2">
                 <label className="text-[10px] uppercase text-neutral-600 font-bold tracking-widest flex justify-between">Magnification <span>{magnification}x</span></label>
                 <input type="range" min="0.1" max="5" step="0.1" value={magnification} onChange={(e) => setMagnification(parseFloat(e.target.value))} className="w-full h-1 bg-neutral-900 appearance-none accent-white cursor-pointer" />
              </div>
           </div>
        </div>
        ...
        <div className="lg:col-span-8 bg-[#0a0a0a] border border-neutral-800 p-12 flex flex-col justify-center items-center gap-12 text-center">
           <div className="space-y-4">
              <div className="text-[10px] uppercase font-bold text-neutral-600 tracking-[0.4em]">Effective Diffraction Limit</div>
              <div className="text-[140px] font-mono leading-none text-white tracking-tighter">
                f/{effectiveLimit.toFixed(1)}
              </div>
              <p className="text-xs text-neutral-500 uppercase tracking-[0.2em] max-w-md mx-auto leading-relaxed italic">
